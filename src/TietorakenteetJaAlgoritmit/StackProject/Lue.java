...
public class Lue {
    /*************************************** Arto Wikla 1998**********
     ...
     Operaatiot:   TietorakenteetJaAlgoritmit.StackProject.Lue.rivi()    antaa seuraavan syöttörivin    (String)
     TietorakenteetJaAlgoritmit.StackProject.Lue.kluku()     "      "      kokonaisluvun  (int)
     TietorakenteetJaAlgoritmit.StackProject.Lue.dluku()     "      "      desimaaliluvun (double)
     TietorakenteetJaAlgoritmit.StackProject.Lue.merkki()  antaa seuraavan syöttörivin ensimmäisen
     merkin
